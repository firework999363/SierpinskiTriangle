...
public void sierpinski(float x, float y, float z, float len) 
{
	...
	else
	{
		...
		line(x,y,z,x+len/2,y+(len*(((float)Math.sqrt(3))/2)),z-(len/2));
		line(x+len,y,z,x+len/2,y+(len*(((float)Math.sqrt(3))/2)),z-(len/2));
		line(x,y,z-len,x+len/2,y+(len*(((float)Math.sqrt(3))/2)),z-(len/2));
		line(x+len,y,z-len,x+len/2,y+(len*(((float)Math.sqrt(3))/2)),z-(len/2));
	}
}